...
/* --- Dragon pixel art (16 cols × 12 rows, side-view facing RIGHT) ---
 *  0=bg  1=#0a200a(dark)  2=#1a5c1a(body)  3=#3ea83e(light)
 *  4=#f9a825(eye)  5=#f05a22(wing/orange)
 * ------------------------------------------------------------------- */
const DRG_W = 16, DRG_H = 12;
const DRG_PAL = [null, '#0a200a', '#1a5c1a', '#3ea83e', '#f9a825', '#f05a22'];
const DRG_F = [
...
<div id="gm-sp" class="gm-sp" hidden></div>`;
  ...
  _sizeCanvas() {
    ...
    this._px = Math.max(3, Math.floor(Math.min(w, h) / 20));
  }
